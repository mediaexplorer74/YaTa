...
// Type: Yandex.MapKit.Masstransit.Section
...
namespace Yandex.MapKit.Masstransit
{
  ...
  public sealed class Section : __ISectionPublicNonVirtuals
  {
    ...
    public extern IVectorView<RouteStop> Stops { [MethodImpl(MethodCodeType = MethodCodeType.Runtime)] get; }

    public extern IVectorView<Subpolyline> RideLegs { [MethodImpl(MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
