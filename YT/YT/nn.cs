...
public class nn : View.OnClickListener
{
  public nn(TariffListActivity paramTariffListActivity, ColorStateList paramColorStateList1, ColorStateList paramColorStateList2)
  {
  }
  ...
  public virtual void onClick(View paramView)
  {
	...
	if (TariffListActivity.a(this.c).isEconom())
	{
	  ...
	  {
		TariffListActivity.a(this.c).removeClass("econom");
	...
	{
	  TariffListActivity.a(this.c).addClass("econom");
	...
	TariffListActivity.f(this.c).setBackgroundResource(j);
	TariffListActivity.f(this.c).setTextColor(colorStateList1);
